...
Base no PyMySQL (https://github.com/PyMySQL/PyMySQL) that's a pure
python mysql client.
"""
...
class MysqlPacket(object):
    ...
    __slots__ = ('_position', '_data', '_packet_number', 'connection')
...
class FieldDescriptorPacket(MysqlPacket):
    ...
    @coroutine
    def recv_packet(self):
        yield super(FieldDescriptorPacket, self).recv_packet()
        self.__parse_field_descriptor(self.connection.encoding)
...
class Connection(object):
    ...
    def execute_query(self, sql, unbuffered=False):
        ...
        self._affected_rows = yield self._read_query_result(unbuffered=unbuffered)
    ...
    def _read_query_result(self, unbuffered=False):
        ...
        raise Return(result.affected_rows)
...
class MySQLResult(object):
    ...
    def _read_rowdata_packet_unbuffered(self):
        ...
        row = yield self._read_row_from_packet(packet)
